...
export default {
    ...
    execute: function (__, context) {
        ...
        function createMembraneMarshall(globalObject) {
            ...
            const TypedArrayProtoLengthGetter = ReflectApply(ObjectProtoLookupGetter, _.Uint8Array.prototype.__proto__, ['length']);
            ...
            const consoleObject = !IS_IN_SHADOW_REALM && typeof _.console === 'object' && _.console !== null ? _.console : _.undefined;
            ...
            return function createHooksCallback(color, foreignCallableHooksCallback, options) {
                const { distortionCallback = identity, instrumentation, // eslint-disable-next-line prefer-object-spread
                 } = ObjectAssign({
                    __proto__: null,
                }, options);
                ...
                function createApplyOrConstructTrapForAnyNumberOfArgs(proxyTrapEnum) {
                    ...
                    return function applyOrConstructTrapForAnyNumberOfArgs(_shadowTarget, thisArgOrArgs, argsOrNewTarget) {
                        ...
                        try {
                            ...
                            pointerOrPrimitive = ReflectApply(foreignCallableApplyOrConstruct, _.undefined, combinedArgs);
                        }
                        catch (error) {
                ...
                class BoundaryProxyHandler {
                    ...
                    makeProxyStatic() {
                        ...
                        const { foreignTargetPointer: foreignTargetPointer1, foreignTargetTraits: foreignTargetTraits1, shadowTarget: shadowTarget1, } = this; // We don't wrap `foreignCallableGetTargetIntegrityTraits()`
                    ...
                    static passthruDefinePropertyTrap(_shadowTarget, key, unsafePartialDesc) {
                        ...
                        const valuePointer = 'value' in safePartialDesc
                        ...
                        const getterPointer = 'get' in safePartialDesc
                            ? typeof getter === 'function'
                                ? getTransferablePointer(getter)
                                : getter
                            : LOCKER_NEAR_MEMBRANE_UNDEFINED_VALUE_SYMBOL;
                        const setterPointer = 'set' in safePartialDesc
                        ...
                        try {
                            result = foreignCallableDefineProperty(foreignTargetPointer1, key, 'configurable' in safePartialDesc
                                ...
                                : LOCKER_NEAR_MEMBRANE_UNDEFINED_VALUE_SYMBOL, valuePointer, getterPointer, setterPointer, nonConfigurableDescriptorCallback);
                        }
                        catch (error) {
                                ...
                                if (getter) {
                                    if (safeDesc.foreign) {
                                        ...
                                        try {
                                            ...
                                            const errorToThrow = (_selectedTarget23 = selectedTarget) != null
                                                ? _selectedTarget23
                                                : error;
                                            selectedTarget = _.undefined;
                                            if (LOCKER_DEBUG_MODE_INSTRUMENTATION_FLAG) {
                ...
                pushTarget, (targetPointer, thisArgPointerOrUndefined, ...args) => {
                    ...
                    : noop, installErrorPrepareStackTrace, IS_IN_SHADOW_REALM
...
//# sourceMappingURL=createMembraneMarshall.js.map